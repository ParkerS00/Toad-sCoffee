...
using ToadsCoffee.EmployeeManager.Data;
using ToadsCoffee.EmployeeManager.Shared;
...
// will create the database if you don't have one and run all the pending migrations
