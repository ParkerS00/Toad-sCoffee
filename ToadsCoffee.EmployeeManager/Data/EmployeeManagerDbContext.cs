...
using ToadsCoffee.EmployeeManager.Data.Models;

namespace ToadsCoffee.EmployeeManager.Data
{
    public class EmployeeManagerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department>().HasData(
                ...
                new Department { Id = 4, Name = "Toad Resources" },
            ...
            modelBuilder.Entity<Employee>().HasData(
                ...
                new Employee { Id = 7, FirstName = "Sophie", LastName = "Ramos", DepartmentId = 3 },
                ...
                new Employee { Id = 10, FirstName = "Jasmine", LastName = "Curtis", DepartmentId = 1, IsDeveloper = true });
        }
    }
}
